    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white-6 to-white py-12 px-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-blue-4/20">
          ...
          <button className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-navy-3/20 rounded-lg text-navy-2 font-medium hover:bg-white-6 transition mb-4">
          ...
          <p className="text-center text-xs text-navy-3 mt-6">
            ...
            <Link to="/fair-use" className="text-blue-4 hover:underline">Fair Use Policy</Link>.
          </p>
        </div>
      </div>
    </div>
